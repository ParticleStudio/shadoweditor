...
#define expected_lite_VERSION                    \
    expected_STRINGIFY(expected_lite_MAJOR       \
    ) "." expected_STRINGIFY(expected_lite_MINOR \
...
#define nsel_COMPILER_VERSION(major, minor, patch) \
...
#define nsel_deprecated(msg) /*[[deprecated]]*/
    ...
    struct is_swappable {
        template<
                typename T, typename = decltype(swap(
    ...
    template<
            typename FnT, typename ClassT, typename ObjectT,
    ...
    nsel_constexpr auto invoke_member_function_impl(
            FnT ClassT::*memfnptr, ObjectT &&obj, Args &&...args
        ...
        return (std::forward<ObjectT>(obj).*
                memfnptr)(std::forward<Args>(args)...);
    }

    template<
            typename FnT, typename ClassT, typename ObjectT,
            typename... Args nsel_REQUIRES_T(
                    std::is_function<FnT>::value &&is_reference_wrapper<
                            typename std20::remove_cvref<ObjectT>::type>::value
            )>
    nsel_constexpr auto invoke_member_function_impl(
            FnT ClassT::*memfnptr, ObjectT &&obj, Args &&...args
    ...
    nsel_constexpr auto invoke_member_function_impl(
            ...
            -> decltype(((*std::forward<ObjectT>(obj)).*memfnptr)(
    ...
    template<
            typename MemberT, typename ClassT,
    ...
    nsel_constexpr auto invoke_member_object_impl(
            MemberT ClassT::*memobjptr, ObjectT &&obj
    ...
    nsel_constexpr auto invoke(F &&f, Args &&...args) noexcept(
            noexcept(invoke_member_function_impl(
        ...
        return invoke_member_function_impl(
                std::forward<F>(f), std::forward<Args>(args)...
        );
    }
    ...
    nsel_constexpr auto invoke(F &&f, Args &&...args) noexcept(
            noexcept(invoke_member_object_impl(
                    std::forward<F>(f), std::forward<Args>(args)...
            ))
    )
            -> decltype(invoke_member_object_impl(
                    std::forward<F>(f), std::forward<Args>(args)...
            )) {
        return invoke_member_object_impl(
                std::forward<F>(f), std::forward<Args>(args)...
        );
    }
    ...
    using invoke_result_nocvref_t = typename std20::remove_cvref<
            decltype(invoke(std::declval<F>(), std::declval<Args>()...))>::type;

#if nsel_P2505R >= 5
    template<typename F, typename... Args>
    using transform_invoke_result_t = typename std::remove_cv<
            decltype(invoke(std::declval<F>(), std::declval<Args>()...))>::type;
#else
    template<typename F, typename... Args>
    ...
    template<typename T>
    struct valid_expected_value_type: std::integral_constant<
...
#endif// nsel_P0323R
    {
     ...
     public:
        ...
        template<typename... Args nsel_REQUIRES_T(std::is_constructible<
                                                  E, Args &&...>::value)>
        constexpr explicit unexpected_type(
                nonstd_lite_in_place_t(E), Args &&...args
        ): m_error(std::forward<Args>(args)...) {}

        template<
                typename U,
                typename... Args nsel_REQUIRES_T(std::is_constructible<
                                                 E, std::initializer_list<U>,
                                                 Args &&...>::value)>
        constexpr explicit unexpected_type(
                nonstd_lite_in_place_t(E), std::initializer_list<U> il,
                Args &&...args
        ...
        template<typename E2 nsel_REQUIRES_T(
                ...
                !std::is_same<
                        typename std20::remove_cvref<E2>::type,
                        nonstd_lite_in_place_t(E2)>::value &&
                !std::is_same<
                        typename std20::remove_cvref<E2>::type,
                        unexpected_type>::value
        )>
        ...
        constexpr explicit unexpected_type(unexpected_type<E2> const &error): m_error(E{error.error()}) {}
        ...
        constexpr /*non-explicit*/ unexpected_type(
                unexpected_type<E2> const &error
        ): m_error(error.error()) {}
        ...
        constexpr explicit unexpected_type(unexpected_type<E2> &&error): m_error(E{std::move(error.error())}) {}
        ...
        constexpr /*non-explicit*/ unexpected_type(unexpected_type<E2> &&error): m_error(std::move(error.error())) {}

        // x.x.5.2.2 Assignment

        nsel_constexpr14 unexpected_type &operator=(unexpected_type const &) =
                default;
        nsel_constexpr14 unexpected_type &operator=(unexpected_type &&) =
                default;

        template<typename E2 = E>
        nsel_constexpr14 unexpected_type &operator=(
                unexpected_type<E2> const &other
        ) {
        ...
        nsel_REQUIRES_R(void, std17::is_swappable<U>::value)
                swap(unexpected_type &other
                ) noexcept(std17::is_nothrow_swappable<U>::value) {
            using std::swap;
    ...
    constexpr bool operator==(
            unexpected_type<E1> const &x, unexpected_type<E2> const &y
    ) {
    ...
    template<typename E>
    constexpr bool operator<(
            unexpected_type<E> const &x, unexpected_type<E> const &y
    ) {
        return x.error() < y.error();
    }
    ...
    void swap(unexpected_type<E> &x, unexpected_type<E> &y) noexcept(
            noexcept(x.swap(y))
    ) {
        x.swap(y);
    }
    ...
    nsel_constexpr14 auto make_unexpected(E &&value
        ...
        return unexpected_type<typename std::decay<E>::type>(
                std::forward<E>(value)
        );
    }
...
#if nsel_CONFIG_NO_EXCEPTIONS_SEH
            RaiseException(
                    EXCEPTION_ACCESS_VIOLATION, EXCEPTION_NONCONTINUABLE, 0,
                    NULL
            );
#else
            assert(false &&
                   detail::text("throw bad_expected_access<Error>{ e };"));
#endif
        }
    };
    ...
    template<typename T>
    struct valid_unexpected_type: std::integral_constant<
                                          bool,
...
#endif// nsel_P0323R
    {
     ...
     public:
        ...
        nsel_REQUIRES_0(std::is_default_constructible<T>::value
        ) nsel_constexpr14 expected(): contained(true) {
        ...
        nsel_constexpr14 /*non-explicit*/ expected(expected<U, G> const &other): contained(other.has_value()) {
            if(has_value())
        ...
        nsel_constexpr14 /*non-explicit*/ expected(expected<U, G> &&other): contained(other.has_value()) {
            if(has_value())
        ...
        template<
                typename U =
                        T nsel_REQUIRES_T(std::is_copy_constructible<U>::value)>
        nsel_constexpr14 expected(value_type const &value): contained(true) {
            contained.construct_value(value);
        }

        template<
                typename U = T nsel_REQUIRES_T(
                        std::is_constructible<T, U &&>::value &&
                        !std::is_same<
        ...
        template<
                typename G = E nsel_REQUIRES_T(
                        std::is_constructible<E, G const &>::value &&
                        !std::is_convertible<
                                G const &, E>::value /*=> explicit */
                )>
        nsel_constexpr14 explicit expected(
                nonstd::unexpected_type<G> const &error
        ): contained(false) {
        ...
        nsel_constexpr14 /*non-explicit*/ expected(
                nonstd::unexpected_type<G> const &error
        ): contained(false) {
        ...
        nsel_constexpr14 /*non-explicit*/ expected(
                nonstd::unexpected_type<G> &&error
        ): contained(false) {
        ...
        template<typename... Args nsel_REQUIRES_T(std::is_constructible<
                                                  T, Args &&...>::value)>
        nsel_constexpr14 explicit expected(
                nonstd_lite_in_place_t(T), Args &&...args
        ): contained(true) {
        ...
        template<
                ...
                typename... Args nsel_REQUIRES_T(std::is_constructible<
                                                 ...
                                                 Args &&...>::value)>
        nsel_constexpr14 explicit expected(
                nonstd_lite_in_place_t(T), std::initializer_list<U> il,
                Args &&...args
        ): contained(true) {
        ...
        template<typename U nsel_REQUIRES_T(
                ...
                std17::conjunction<
                        std::is_scalar<T>,
                        std::is_same<T, std::decay<U> > >::value &&
                std::is_constructible<T, U>::value &&
        ...
        template<
                typename G = E nsel_REQUIRES_T(
                        std::is_constructible<
                                E,
                                G const &>::value &&std::is_copy_constructible<G>::
                                value// TODO: std::is_nothrow_copy_constructible<G>
        ...
        template<
                typename G = E nsel_REQUIRES_T(
                        std::is_constructible<
                                E,
                                G &&>::value &&std::is_move_constructible<G>::
                                value// TODO: std::is_nothrow_move_constructible<G>
        ...
        template<typename... Args nsel_REQUIRES_T(std::is_nothrow_constructible<
                                                  T, Args &&...>::value)>
        value_type &emplace(Args &&...args) {
            expected(nonstd_lite_in_place(T), std::forward<Args>(args)...)
                    .swap(*this);
            return value();
        }
        ...
        template<
                typename U,
                typename... Args nsel_REQUIRES_T(std::is_nothrow_constructible<
                                                 T, std::initializer_list<U> &,
                                                 Args &&...>::value)>
        value_type &emplace(std::initializer_list<U> il, Args &&...args) {
            expected(nonstd_lite_in_place(T), il, std::forward<Args>(args)...)
                    .swap(*this);
            return value();
        }
        ...
        )// warning C4702: unreachable code, see issue 65.
        ...
        nsel_RESTORE_MSVC_WARNINGS()
            ...
            return std::move(
                    has_value() ? (contained.value())
                                : (error_traits<error_type>::rethrow(
                                           contained.error()
                                   ),
                                   contained.value())
            );
        ...
        bool has_exception() const {
            using ContainedEx = typename std::remove_reference<
                    decltype(get_unexpected().value())>::type;
            return !has_value() && std::is_base_of<Ex, ContainedEx>::value;
        }

        template<typename U nsel_REQUIRES_T(std::is_copy_constructible<T>::value
                                                    &&std::is_convertible<
                                                            U &&, T>::value)>
        ...
        template<typename U nsel_REQUIRES_T(std::is_move_constructible<T>::value
                                                    &&std::is_convertible<
                                                            U &&, T>::value)>
        ...
        template<typename F nsel_REQUIRES_T(
                detail::is_expected<detail::invoke_result_nocvref_t<
                        ...
                        is_same<typename detail::invoke_result_nocvref_t<
                                        F, value_type &>::error_type,
                                error_type>::value
                                &&std::is_constructible<
                                        error_type, error_type &>::value
        )>
        nsel_constexpr14 detail::invoke_result_nocvref_t<F, value_type &>
        and_then(F &&f) & {
            return has_value()
        ...
        template<typename F nsel_REQUIRES_T(
                detail::is_expected<detail::invoke_result_nocvref_t<
                        F, const value_type &> >::value &&std::
                        is_same<typename detail::invoke_result_nocvref_t<
                                        F, const value_type &>::error_type,
                                error_type>::value
                                &&std::is_constructible<
                                        error_type, const error_type &>::value
        )>
        ...
        nsel_constexpr detail::invoke_result_nocvref_t<F, const value_type &&>
        and_then(F &&f) const && {
            return has_value() ? detail::invoke_result_nocvref_t<
                                         F, const value_type &&>(detail::invoke(
        ...
        template<typename F nsel_REQUIRES_T(
                detail::is_expected<detail::invoke_result_nocvref_t<
                        ...
                        is_same<typename detail::invoke_result_nocvref_t<
                                        F, error_type &>::value_type,
                                value_type>::value
                                &&std::is_constructible<
                                        value_type, value_type &>::value
        )>
        nsel_constexpr14 detail::invoke_result_nocvref_t<F, error_type &>
        or_else(F &&f) & {
            return has_value()
        ...
        template<typename F nsel_REQUIRES_T(
                detail::is_expected<detail::invoke_result_nocvref_t<
                        F, const error_type &> >::value &&std::
                        is_same<typename detail::invoke_result_nocvref_t<
                                        F, const error_type &>::value_type,
                                value_type>::value
                                &&std::is_constructible<
                                        value_type, const value_type &>::value
        )>
        nsel_constexpr detail::invoke_result_nocvref_t<F, const error_type &>
        or_else(F &&f) const & {
            return has_value() ? detail::invoke_result_nocvref_t<
                                         F, const error_type &>(value())
                               : detail::invoke_result_nocvref_t<
                                         F, const error_type &>(detail::invoke(
        ...
        or_else(F &&f) const && {
            return has_value()
                           ? detail::invoke_result_nocvref_t<
                                     F, const error_type &&>(std::move(value()))
                           : detail::invoke_result_nocvref_t<
                                     F, const error_type &&>(detail::invoke(
        ...
        template<typename F nsel_REQUIRES_T(
                ...
                detail::valid_expected_value_type<
                        detail::transform_invoke_result_t<F, value_type &> >::
                        value
        )>
        nsel_constexpr14 expected<
                detail::transform_invoke_result_t<F, value_type &>, error_type>
        transform(F &&f) & {
            return has_value() ? expected<
                                         detail::transform_invoke_result_t<
                                                 F, value_type &>,
                                         error_type>(detail::invoke(
        ...
        template<typename F nsel_REQUIRES_T(
                ...
                !std::is_void<detail::transform_invoke_result_t<
                        F, const value_type &> >::value &&
                detail::valid_expected_value_type<
                        detail::transform_invoke_result_t<
                                F, const value_type &> >::value
        )>
        nsel_constexpr expected<
                detail::transform_invoke_result_t<F, const value_type &>,
                error_type>
        transform(F &&f) const & {
            return has_value() ? expected<
                                         detail::transform_invoke_result_t<
        ...
        nsel_constexpr14 expected<
                value_type, detail::transform_invoke_result_t<F, error_type &> >
        transform_error(F &&f) & {
            return has_value()
                           ? expected<
                                     value_type,
                                     detail::transform_invoke_result_t<
                                             F, error_type &> >(in_place, **this)
                           : make_unexpected(
                                     detail::invoke(std::forward<F>(f), error())
                             );
        }
        ...
        template<typename F nsel_REQUIRES_T(
                detail::valid_unexpected_type<detail::transform_invoke_result_t<
                        F, const error_type &> >::value &&std::
                        is_constructible<value_type, const value_type &>::value
        )>
        nsel_constexpr expected<
                value_type,
                detail::transform_invoke_result_t<F, const error_type &> >
        ...
        nsel_constexpr14 expected<
                value_type,
                detail::transform_invoke_result_t<F, error_type &&> >
        transform_error(F &&f) && {
            return has_value() ? expected<
                                         value_type,
                                         detail::transform_invoke_result_t<
    ...
    class expected<void, E> {
     ...
     public:
        ...
        nsel_REQUIRES_R(
                void, std17::is_swappable<G>::value
                              &&std::is_move_constructible<G>::value
        )
                swap(expected &other) noexcept(
                        std::is_nothrow_move_constructible<E>::value &&
        ...
        template<typename F nsel_REQUIRES_T(
                detail::is_expected<detail::invoke_result_nocvref_t<F> >::value
                        &&std::is_same<
                                typename detail::invoke_result_nocvref_t<
                                        F>::error_type,
                                error_type>::value
                                &&std::is_constructible<
                                        error_type, error_type &>::value
        ...
        nsel_constexpr14 detail::invoke_result_nocvref_t<F> and_then(F &&f) & {
            return has_value() ? detail::invoke_result_nocvref_t<F>(
                                         detail::invoke(std::forward<F>(f))
                                 )
                               : detail::invoke_result_nocvref_t<F>(
                                         unexpect, error()
                                 );
        }
        ...
        nsel_constexpr detail::invoke_result_nocvref_t<F> and_then(F &&f
        ) const & {
            return has_value() ? detail::invoke_result_nocvref_t<F>(
                                         detail::invoke(std::forward<F>(f))
                                 )
        ...
        nsel_constexpr14
                expected<detail::transform_invoke_result_t<F>, error_type>
                transform(F &&f) & {
            return has_value()
                           ? expected<
                                     detail::transform_invoke_result_t<F>,
                                     error_type>(detail::invoke(std::forward<F>(f)
                             ))
                           : make_unexpected(error());
        }

        template<typename F nsel_REQUIRES_T(
                std::is_constructible<error_type, error_type &>::value &&std::
                        is_void<detail::transform_invoke_result_t<F> >::value
        )>
        nsel_constexpr14 expected<void, error_type> transform(F &&f) & {
            return has_value() ? (detail::invoke(std::forward<F>(f)),
                                  expected<void, error_type>())
                               : make_unexpected(error());
        }
        ...
        template<typename F nsel_REQUIRES_T(
                std::is_constructible<error_type, const error_type &>::value
                        &&std::is_void<
                                detail::transform_invoke_result_t<F> >::value
        )>
        nsel_constexpr expected<void, error_type> transform(F &&f) const & {
            return has_value() ? (detail::invoke(std::forward<F>(f)),
                                  expected<void, error_type>())
        ...
        template<typename F nsel_REQUIRES_T(detail::valid_unexpected_type<
                                            detail::transform_invoke_result_t<
                                                    F, error_type &> >::value)>
        nsel_constexpr14 expected<
                void, detail::transform_invoke_result_t<F, error_type &> >
        transform_error(F &&f) & {
            return has_value()
                           ? expected<
        ...
        nsel_constexpr expected<
                void, detail::transform_invoke_result_t<F, const error_type &> >
        transform_error(F &&f) const & {
            return has_value()
                           ? expected<
                                     void, detail::transform_invoke_result_t<
     ...
     private:
        detail::storage_t<
                void, E, std::is_copy_constructible<E>::value,
                std::is_move_constructible<E>::value>
                contained;
    };
    ...
    template<
            typename T1, typename E1, typename T2,
            typename E2 nsel_REQUIRES_T(
                    !std::is_void<T1>::value && !std::is_void<T2>::value
            )>
    constexpr bool operator==(
            expected<T1, E1> const &x, expected<T2, E2> const &y
    ) {
    ...
    template<
            typename T1, typename E1, typename T2,
            typename E2 nsel_REQUIRES_T(std::is_void<T1>::value
    ...
    template<typename T, typename E>
    constexpr bool operator<=(
            expected<T, E> const &x, expected<T, E> const &y
    ) {
        return !(y < x);
    }
    ...
    template<
            ...
            typename T2 nsel_REQUIRES_T(!std::is_void<T1>::value)>
    ...
    constexpr bool operator==(
            expected<T1, E1> const &x, unexpected_type<E2> const &u
    ) {
    ...
    template<typename T1, typename E1, typename E2>
    constexpr bool operator==(
            unexpected_type<E2> const &u, expected<T1, E1> const &x
    ) {
        return (x == u);
    }
    ...
    template<typename T, typename E>
    constexpr bool operator<(
            expected<T, E> const &x, unexpected_type<E> const &u
    ) {
        return (!x) ? (x.get_unexpected() < u) : false;
    }
    ...
    template<typename T, typename E>
    constexpr bool operator<(
            unexpected_type<E> const &u, expected<T, E> const &x
    ) {
    ...
    auto make_expected_from_exception(std::exception_ptr v) -> expected<T> {
        return expected<T>(unexpected_type<std::exception_ptr>(
                std::forward<std::exception_ptr>(v)
        ));
    }
