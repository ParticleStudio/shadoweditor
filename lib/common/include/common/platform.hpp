#ifndef SHADOW_PLATFORM_HPP
#define SHADOW_PLATFORM_HPP
...
//
static constexpr uint16_t PLATFORM_OS_FREE_BSD = 0x0001;
static constexpr uint16_t PLATFORM_OS_AIX = 0x0002;
static constexpr uint16_t PLATFORM_OS_HPUX = 0x0003;
static constexpr uint16_t PLATFORM_OS_TRU64 = 0x0004;
static constexpr uint16_t PLATFORM_OS_LINUX = 0x0005;
static constexpr uint16_t PLATFORM_OS_MAC_OS_X = 0x0006;
static constexpr uint16_t PLATFORM_OS_NET_BSD = 0x0007;
static constexpr uint16_t PLATFORM_OS_OPEN_BSD = 0x0008;
static constexpr uint16_t PLATFORM_OS_IRIX = 0x0009;
static constexpr uint16_t PLATFORM_OS_SOLARIS = 0x000a;
static constexpr uint16_t PLATFORM_OS_QNX = 0x000b;
static constexpr uint16_t PLATFORM_OS_VXWORKS = 0x000c;
static constexpr uint16_t PLATFORM_OS_CYGWIN = 0x000d;
static constexpr uint16_t PLATFORM_OS_NACL = 0x000e;
static constexpr uint16_t PLATFORM_OS_ANDROID = 0x000f;
static constexpr uint16_t PLATFORM_OS_UNKNOWN_UNIX = 0x00ff;
static constexpr uint16_t PLATFORM_OS_WINDOWS_NT = 0x1001;
static constexpr uint16_t PLATFORM_OS_WINDOWS_CE = 0x1011;
static constexpr uint16_t PLATFORM_OS_VMS = 0x2001;
...
//
static constexpr uint8_t PLATFORM_ARCH_ALPHA = 0x01;
static constexpr uint8_t PLATFORM_ARCH_IA32 = 0x02;
static constexpr uint8_t PLATFORM_ARCH_IA64 = 0x03;
static constexpr uint8_t PLATFORM_ARCH_MIPS = 0x04;
static constexpr uint8_t PLATFORM_ARCH_HPPA = 0x05;
static constexpr uint8_t PLATFORM_ARCH_PPC = 0x06;
static constexpr uint8_t PLATFORM_ARCH_POWER = 0x07;
static constexpr uint8_t PLATFORM_ARCH_SPARC = 0x08;
static constexpr uint8_t PLATFORM_ARCH_AMD64 = 0x09;
static constexpr uint8_t PLATFORM_ARCH_ARM = 0x0a;
static constexpr uint8_t PLATFORM_ARCH_M68K = 0x0b;
static constexpr uint8_t PLATFORM_ARCH_S390 = 0x0c;
static constexpr uint8_t PLATFORM_ARCH_SH = 0x0d;
static constexpr uint8_t PLATFORM_ARCH_NIOS2 = 0x0e;
static constexpr uint8_t PLATFORM_ARCH_AARCH64 = 0x0f;
static constexpr uint8_t PLATFORM_ARCH_ARM64 = 0x0f; // same as PLATFORM_ARCH_AARCH64
static constexpr uint8_t PLATFORM_ARCH_RISCV64 = 0x10;
static constexpr uint8_t PLATFORM_ARCH_RISCV32 = 0x11;
static constexpr uint8_t PLATFORM_ARCH_LOONGARCH64 = 0x12;
